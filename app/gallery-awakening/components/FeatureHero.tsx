...
export const FeatureHero: React.FC<FeatureHeroProps> = ({ autoBox }) => {
  ...
  return (
    <section className="rounded-3xl border border-emerald-900/60 bg-gradient-to-br from-zinc-950 via-zinc-950/90 to-emerald-950/40 p-4 shadow-lg shadow-emerald-900/20">
      <div className="flex flex-col gap-4 md:flex-row md:items-start">
        <div className="flex-1 space-y-2">
          <p className="inline-flex items-center gap-2 rounded-full border border-emerald-700/60 bg-emerald-500/10 px-3 py-1 text-[11px] font-semibold uppercase tracking-[0.18em] text-emerald-300">
            {autoBox.label}
          </p>
